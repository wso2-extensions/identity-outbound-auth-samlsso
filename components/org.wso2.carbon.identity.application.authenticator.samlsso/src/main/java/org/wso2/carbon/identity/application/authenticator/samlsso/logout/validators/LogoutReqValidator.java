 ...
 */
public class LogoutReqValidator {

    private static final Log log = LogFactory.getLog(LogoutReqValidator.class);
    private SAMLMessageContext samlMessageContext;

    public LogoutReqValidator(SAMLMessageContext samlMessageContext) {
    ...
    public boolean isValidate(LogoutRequest logoutRequest) {
        ...
        logoutRequestValidators.add(LambdaExceptionUtil.rethrowConsumer(this::isSignatureValid));
     ...
     */
    private void isSignatureValid(LogoutRequest logoutRequest) throws SAMLIdentityException {
